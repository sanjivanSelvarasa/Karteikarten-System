...
function openDetails(set: DashboardSet) { selectedSet.value = set; activeModal.value = 'details' }
  ...
  <div class="dashboard">
    <aside class="sidebar" aria-label="Hauptnavigation">
      ...
      <section class="upgrade-card">
        ...
        <button @click="activeModal = 'upgrade'">Jetzt upgraden</button>
      </section>
      <div class="user-mini">
...
@media (max-width: 880px) { .sidebar { display: none; }.topbar { padding: 16px 22px; }.content { padding: 24px 22px 40px; }.search input { width: 210px; } }
